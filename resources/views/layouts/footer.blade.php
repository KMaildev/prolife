        ...
        <div class="row">
                ...
                <div class="footer-about-1">
                    <div class="footer-about-1-content">
                        <div class="footer-logo footer-logo-3 mb-30">
                            <a href="#"><img src="{{ asset('assets/img/footer-logo/f-logo.png') }}"
                                    alt=""></a>
                        </div>
                        <p class="mb-50">Sed perspiciatis unde omnis natus error voluptatem accusan doloreqe
                            laudantium totam aperiam eaque sipsa quae abillo inventore</p>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                <div class="footer-widget footer-3 footer-btm-mobile ml-50">
                    ...
                    <ul class="footer-widget_menu-link">
                        <li><a href="partners.html">Visitor Visas</a></li>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6">
                <div class="footer-widget footer-4 footer-btm-mobile ml-40">
                    ...
                    <ul class="footer-widget_menu-link-info">
                        <li><a href="tel:1587203692"><i class="far fa-phone-alt"></i> <span> 1 587 203 692</span>
                            </a></li>
                        <li><a href="https://wphix.com/cdn-cgi/l/email-protection#63101613130c111723040e020a0f4d000c0e"><i
                                    class="fal fa-envelope"></i> <span><span class="__cf_email__"
                                        data-cfemail="2e5d5b5e5e415c5a6e49434f4742004d4143">[email&#160;protected]</span></span></a>
                        </li>
                        <li><a href="contact.html"><i class="fal fa-map-marker-alt"></i> <span>250 Halderman Rd,
                                    West Alexandria, OH, 45381</span> </a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row copyright-botom-padding align-items-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="copyright-botom">
                            <p>Copyright ©2021 <a href="#"> <span>BDevs</span></a>. All Rights Reserved</p>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
